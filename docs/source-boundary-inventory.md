...
| `github.com/tako0614/takoform-forms`              | Publisher family declarations, family corpora, package production and tako0614 publisher evidence    |
...
- At this counted historical baseline, eight selected family groups contained
  31 Forms: Edge 16, Function 4,
...
| ----------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| `formpackage/`                                                                                        | Exact FormRef, package schemas, canonicalization, closure verification                              | `takoform`                                                                       | Core package verifier; consumed equally for publisher and external packages                                                           |
...
| `internal/currentformmodel/`                                                                          | Rich Go authoring DSL used to emit publisher definitions and fixtures                                | `takoform-forms`                                                                 | Publisher implementation detail; portable formats stay in Core, but this directory is not a Core extension API                       |
| `internal/edgeformcatalog/`                                                                           | 16 current Edge Forms, 7 Interfaces, 6 Bindings and family fixtures                                 | `takoform-forms`                                                                 | tako0614 publisher source; emits data-only artifacts through the common verifier                                                     |
| `internal/functionformcatalog/`                                                                       | 4 Function Forms and `function.runtime@1.0.0`                                                       | `takoform-forms`                                                                 | tako0614 publisher source                                                                                                            |
| `internal/containerformcatalog/`                                                                      | 5 Container Forms and `container.runtime@1.0.0`                                                     | `takoform-forms`                                                                 | tako0614 publisher source                                                                                                            |
| `internal/tableformcatalog/`                                                                          | 1 Table Form and `table.document@1.0.0`                                                             | `takoform-forms`                                                                 | tako0614 publisher source                                                                                                            |
| `internal/queueformcatalog/`                                                                          | 1 PullQueue Form and `queue.pull@1.0.0`                                                             | `takoform-forms`                                                                 | tako0614 publisher source; dependency root for Topic and Schedule                                                                    |
| `internal/topicformcatalog/`                                                                          | 2 Topic Forms and `topic.publish@1.0.0`                                                             | `takoform-forms`                                                                 | tako0614 publisher source; consumes the exact Queue Interface ref                                                                    |
| `internal/scheduleformcatalog/`                                                                       | 1 Schedule Form                                                                                     | `takoform-forms`                                                                 | tako0614 publisher source; consumes exact Queue and Topic Interface refs                                                             |
| `internal/vectorformcatalog/`                                                                         | 1 VectorIndex Form and its Interface                                                                | `takoform-forms`                                                                 | tako0614 publisher source                                                                                                            |
...
| `conformance/takoform-v1/`                                                                            | Generated Host API v1 corpus selected from all eight current families                               | split generated output                                                           | Generic output is produced by Core conformance; each publisher family corpus is produced by its publisher                             |
...
| `internal/retainededgeformcatalog/`, `internal/provider/testdata/v3-retained-*`                       | Frozen Provider 2.1.1 identities and codecs                                                         | `terraform-provider-takoform`                                                    | Immutable readable state history only; never regenerated from current publisher catalogs                                              |
...
takoform-forms publisher
    -> publisher data-only packages and family corpora
...
4. Current Provider registration, state dispatch, codecs and Terraform naming
   consume the embedded publisher-selected 17-Form projection. Generated docs consume
   that same projection and keep no roster or name map. The complete Provider
   3 projection remains source-side history and is not embedded in the current
   provider binary.
...
consumer lookup and dual writers are removed. Publisher catalog and rendering
