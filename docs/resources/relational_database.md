...
- `schema_url` (String, optional) — Optional immutable migration bundle the host applies in order. Userinfo, query, and fragment are forbidden because this value persists in nonsensitive state.
