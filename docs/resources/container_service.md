...
price, or implementation. See the [complete example](https://takoform.com/examples/resources/takoform_container_service/resource.tf).
...
```console
terraform import takoform_container_service.example \
