...
description: |-
  Object Bucket (edge.forms.takoform.com, role identity).
---
...
This page documents the publisher-set next-major Provider mapping; its exact FormRef `edge.forms.takoform.com/ObjectBucket` is recorded below.
The resource type is Provider metadata. The published Edge Form Definition is maintained in the [takoform-forms source](https://github.com/tako0614/takoform-forms/blob/3231633605b737ce5279d7fc020b4780568e7091/forms/candidates/edge.forms.takoform.com/object-bucket/definition.json).
See the complete exact identity and the [complete example](https://takoform.com/examples/resources/takoform_edge_object_bucket/resource.tf).
...
`packageDigest` — Form Package digest (separate from FormRef; embedded Provider provenance): `sha256:46cd435d838d89de641d38180680e99c8bc7be1a3ae9c123494440d3e6e202ec`.
...
- **Reads dispatch on the recorded FormRef.** `ObjectBucket` state is addressed under the
...
terraform import takoform_edge_object_bucket.example \
  '{"space":"prod","apiVersion":"edge.forms.takoform.com","kind":"ObjectBucket","definitionVersion":"0.1.0","schemaDigest":"sha256:…","name":"…"}'
```
