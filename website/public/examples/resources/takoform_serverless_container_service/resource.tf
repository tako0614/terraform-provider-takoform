...
resource "takoform_serverless_container_service" "example" {
  name = "container-service"
}

output "serverless_container_service_outputs" {
  value = takoform_serverless_container_service.example.outputs_json
}
