...
resource "takoform_container_endpoint" "example" {
  name    = "container-endpoint"
  service = "container-service"
}

output "container_endpoint_hostname" {
  value = takoform_container_endpoint.example.hostname
}

output "container_endpoint_url" {
  value = takoform_container_endpoint.example.url
}
