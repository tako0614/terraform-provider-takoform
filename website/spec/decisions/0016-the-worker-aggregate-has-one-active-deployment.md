...
maintained by Takoform Core; read the exact [Core v1.0.1 source](https://github.com/tako0614/takoform/blob/v1.0.1/spec/decisions/0016-the-worker-aggregate-has-one-active-deployment.md).
