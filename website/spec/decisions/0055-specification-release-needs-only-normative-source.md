...
maintained by Takoform Core; read the exact [Core v1.0.1 source](https://github.com/tako0614/takoform/blob/v1.0.1/spec/decisions/0055-specification-release-needs-only-normative-source.md).
