...
source and history remain in the [Provider repository](https://github.com/tako0614/terraform-provider-takoform/blob/main/proposals/function/function-deployment.md).
