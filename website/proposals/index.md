...
- [Regional Function Family](function/index.md) — regional FaaS, 4 current candidates.
- [Serverless Container Family](container/index.md) — OCI-image services, 5 current candidates.
- [Table Family](table/index.md) — key-addressed document tables, 1 current candidate.
- [Pull Queue Family](queue/index.md) — pull-based at-least-once queues, 1 current candidate.
- [Topic Family](topic/index.md) — fanout topics and queue subscriptions, 2 current candidates.
- [Schedule Family](schedule/index.md) — standalone cron invocation, 1 current candidate.
- [Vector Family](vector/index.md) — fixed-dimension vector indexes, 1 current candidate.
...
Start a new family Proposal by copying `TEMPLATE.md` into the
