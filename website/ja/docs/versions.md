...
| Provider source | **`4.0.0` candidate** | 同じ `tako0614/takoform` addressで公式Edge Form 16種だけを登録。未公開。 |
...
| --- | --- | --- |
| **4.0.0** | current Host API | 公式Edge Form 16種限定のcandidate。Registry公開は未主張。 |
