...
| External Edge publication | [`takoform-forms` at commit `026f862975b9adb0e2bfd9c6214a5e6691dfb596`](https://github.com/tako0614/takoform-forms/commit/026f862975b9adb0e2bfd9c6214a5e6691dfb596) | Publication authority for 16 content-addressed packages. |
...
| Provider | **`3.0.0`** | Registry-published typed implementation with 31 mappings across eight versionless families. |
...
| --- | --- | --- |
| **3.0.0** | Current Host API | 31 typed mappings in eight versionless families; current Registry distribution. |
...
boundary](/release/migrations/v2-to-v3.html); no automatic migration occurs.
