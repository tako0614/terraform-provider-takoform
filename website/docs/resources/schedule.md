...
price, or implementation. See the [complete example](https://takoform.com/examples/resources/takoform_schedule/resource.tf).
...
```console
terraform import takoform_schedule.example \
