...
description: |-
  Worker Endpoint (edge.forms.takoform.com/v1beta2, role attachment).
---
...
terraform import takoform_worker_endpoint.example \
  '{"space":"prod","apiVersion":"edge.forms.takoform.com/v1beta2","kind":"WorkerEndpoint","definitionVersion":"0.1.0","schemaDigest":"sha256:…","name":"…"}'
```
