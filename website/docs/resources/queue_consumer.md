...
terraform import takoform_queue_consumer.example \
  '{"space":"prod","apiVersion":"edge.forms.takoform.com/v1alpha1","kind":"QueueConsumer","definitionVersion":"0.1.0","schemaDigest":"sha256:…","name":"…"}'
```
