...
price, or implementation. See the [complete example](https://takoform.com/examples/resources/takoform_vector_index/resource.tf).
...
```console
terraform import takoform_vector_index.example \
