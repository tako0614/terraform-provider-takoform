...
description: |-
  SQLite Migration Application (edge.forms.takoform.com/v1alpha1, role attachment).
---
...
price, or implementation. See the [complete example](../../examples/resources/takoform_sqlite_migration_application/resource.tf).
...
terraform import takoform_sqlite_migration_application.example \
  '{"space":"prod","apiVersion":"edge.forms.takoform.com/v1alpha1","kind":"SQLiteMigrationApplication","definitionVersion":"0.1.0","schemaDigest":"sha256:…","name":"…"}'
```
