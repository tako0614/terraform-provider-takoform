...
| **Lane** | One exact Host protocol path. Specification 1.0 defines `forms.takoform.com/v1` independently of Provider publication or Form maturity. Registry-published Provider `v2.1.1` remains on retained v1beta1 with 15 Experimental Forms; Provider 3 is a non-normative sample and cannot block the Specification. |
