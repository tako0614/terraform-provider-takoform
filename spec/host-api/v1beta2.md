...
([`../standard-services/README.md`](../standard-services/README.md),
...
([`../schemas/operation-v1alpha2.schema.json`](../schemas/operation-v1alpha2.schema.json))
...
[`../schemas/host-support-profile-v1alpha2.schema.json`](../schemas/host-support-profile-v1alpha2.schema.json).
...
([`../interface-contract/`](../interface-contract/README.md)). The v1beta1
