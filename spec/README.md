...
This is an honest characterization scaffold, not a declaration that every current field is a stable portable standard. No signed Form Package format, trust root, canonical byte serialization, key-custody procedure, or remote package installation implementation is claimed here. Until those decisions and conformance fixtures land, the ten resources are a frozen compatibility candidate.
