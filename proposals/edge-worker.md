...
Takosumi Cloud runs immutable edge applications and Takosumi OSS is the first
reference host. The portable contract must describe the application a consumer
