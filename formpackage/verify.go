...
func VerifyDirectory(root string) (VerificationReport, error) {
	...
	if (index.APIVersion != PackageAPIVersion && index.APIVersion != LegacyContentAddressedPackageAPIVersion && index.APIVersion != CurrentPackageAPIVersion && !FamilyPackageLane(index.APIVersion)) || index.Kind != PackageKind {
