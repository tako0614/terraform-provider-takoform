...
signing/publication and is not reused by this readback lane. Historical
retained admission material continues to verify its already-issued `provider-registry-readback.yml@refs/heads/main` identity; this maintenance release
lane does not rewrite that immutable evidence.
